...
PREFIX = 'wp_loco_dart_%s_' % ( VERSION )
...
class BuildCommand( build_ext ) :
    ...
    def build_extension( self, extension ) :
        ...
        _cmakeArgs = ['-DCMAKE_LIBRARY_OUTPUT_DIRECTORY=' + _extensionDirPath,
                      ...
                      '-DLOCO_CORE_BUILD_WITH_LOGS=ON',
                      '-DLOCO_CORE_BUILD_WITH_TRACK_ALLOCS=ON']
...
setup(
    name                    = 'wp-loco-dart',
    version                 = VERSION,
    description             = 'Dart-backend support for Loco(locomotion framework)',
    author                  = 'Wilbert Santos Pumacay Huallpa',
    license                 = 'MIT License',
    author_email            = 'wpumacay@gmail.com',
    url                     = 'https://github.com/wpumacay/tysocDart',
    keywords                = 'locomotion control simulation dart',
    zip_safe                = False,
