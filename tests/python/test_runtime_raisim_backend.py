...
def test_runtime_dart_backend() :
    ...
    runtime = loco.sim.Runtime( loco.sim.PHYSICS_DART, loco.sim.RENDERING_NONE )
    ...
    simulation.Pause()
    simulation.Resume()
    assert ( simulation.backendId == 'DART' )
...
if __name__ == '__main__' :
    _ = input( 'Press ENTER to start test : test_runtime_dart_backend' )
    test_runtime_dart_backend()
